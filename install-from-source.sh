...
# Todo-Go Installation Script (From Source)
# This script builds and installs todo-go from source code
# Use this if you want to build from the latest source or for development
...
echo -e "${BLUE}╔════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║  Todo-Go Installation (From Source)   ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════╝${NC}"
echo ""
